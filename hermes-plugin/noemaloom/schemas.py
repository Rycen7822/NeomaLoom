    ...
    "parameters": {
        ...
        "properties": {
            ...
            "responseProfile": {
                ...
                "default": "compact",
                "description": "Output profile. compact preserves actionable targets, coverage, warnings, read spans, and required actions while summarizing debug-heavy details; debug preserves full diagnostic payloads.",
            },
        },
        "required": ["goal"],
    },
